...
export default function Gateway() {
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 flex flex-col justify-center items-center relative overflow-hidden font-sans selection:bg-[#3dbca1] selection:text-white">
      ...
      <div className="absolute inset-x-0 h-[2px] bg-gradient-to-r from-transparent via-[#3dbca1]/30 to-transparent animate-[scan_6s_linear_infinite] pointer-events-none z-10" />

      {/* Background Radial Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-[radial-gradient(circle_at_center,rgba(61,188,161,0.05)_0%,transparent_75%)] pointer-events-none z-0" />
      ...
      <div className="w-[90%] max-w-[460px] border border-white/10 bg-zinc-950/60 backdrop-blur-xl rounded-2xl p-8 sm:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.8)] z-20 flex flex-col relative group overflow-hidden">
        {/* Top Highlight line */}
        <div className="absolute top-0 inset-x-0 h-[1px] bg-gradient-to-r from-transparent via-[#3dbca1]/60 to-transparent" />
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 h-12 bg-white/5 border border-white/10 focus:border-[#3dbca1]/50 focus:bg-white/10 text-white rounded-xl text-sm tracking-wide focus:outline-none transition-all duration-300 font-mono animate-none"
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input 
                ...
                placeholder="••••••••••••"
                className="w-full pl-10 pr-4 h-12 bg-white/5 border border-white/10 focus:border-[#3dbca1]/50 focus:bg-white/10 text-white rounded-xl text-sm tracking-wide focus:outline-none transition-all duration-300 font-mono"
              />
            </div>
          </div>
          ...
          <button 
            type="submit"
            disabled={submitting}
            className="w-full h-12 mt-6 bg-[#3dbca1] text-white font-mono uppercase tracking-widest text-xs rounded-xl shadow-[0_4px_20px_rgba(61,188,161,0.3)] hover:bg-[#3dbca1]/80 hover:shadow-[0_0_25px_rgba(61,188,161,0.5)] transition-all active:scale-[0.98] duration-300 disabled:opacity-50 flex items-center justify-center gap-2 cursor-pointer z-30"
          >
            {submitting ? (
              <>
      ...
      <div className="mt-8 z-20 flex gap-6 text-[9px] font-mono text-zinc-600 uppercase tracking-widest pointer-events-none">
        ...
        <span className="flex items-center gap-1.5"><Radio className="w-3.5 h-3.5 animate-pulse text-[#3dbca1]" /> LIVE_DATABOUND</span>
      </div>
    </div>
  );
}
